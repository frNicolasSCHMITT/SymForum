...
class EasyAdminSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(EntityManagerInterface $entityManager,Security $security, UserPasswordHasherInterface $userPasswordHasher)
    {
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            // BeforeEntityUpdatedEvent::class => ['updateArticle'], 
        ];
    }
